...
if (!cal.dtz) {
  cal.dtz = {
    get defaultTimezone() {
      return cal.calendarDefaultTimezone();
    },
    get floating() {
      return cal.floating();
    },
...
if (!cal.item) {
  cal.item = {
    ...
    get productId() {
      return cal.calGetProductId();
    },
    get productVersion() {
      return cal.calGetProductVersion();
    },
...
if (typeof cal.category == "undefined") {
  cal.category = {
    stringToArray: function(aStr) {
      return cal.categoriesStringToArray(aStr);
    },
    arrayToString: function(aArr) {
      return cal.categoriesArrayToString(aArr);
    },
  };
}
...
if (typeof cal.itip.isInvitation == "undefined") {
  cal.itip.isInvitation = function(aItem) {
    return cal.isInvitation(aItem);
  };
}
