...
var { DB_SCHEMA_VERSION, getSqlTable, upgradeDB } = ChromeUtils.import(
  "resource://calendar/modules/calStorageUpgrade.jsm"
);
        ...
        try {
          ...
          try {
            if (this.mDB.tableExists("cal_events")) {
              ...
              // migration done in the meantime
          ...
          for (let tbl of tables) {
            ...
            try {
              stmt = db.createStatement(
                "UPDATE " + tbl + "   SET cal_id = :cal_id" + " WHERE cal_id = :old_cal_id"
              );
