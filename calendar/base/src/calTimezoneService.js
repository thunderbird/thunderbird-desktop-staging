    ...
    if (zoneInfoIdFromOSUserTimeZone != null) {
      ...
      switch (score) {
        case 0:
          ...
          cal.WARN(
            calProperties.formatStringFromName(
              "WarningOSTZNoMatch",
              [osUserTimeZone, zoneInfoIdFromOSUserTimeZone],
              2
            )
          );
          break;
        ...
        case 2:
          ...
          probableTZSource = calProperties.formatStringFromName("TZFromOS", [osUserTimeZone], 1);
  ...
  try {
    ...
    for (let bareTZId of bundleTZIds) {
      ...
      try {
        ...
        let errMsg = calProperties.formatStringFromName("SkippingLocaleTimezone", [bareTZId], 1);
        Cu.reportError(errMsg + " " + ex);
      }
    }
  } catch (ex) {
  ...
  try {
    switch (probableTZScore) {
      ...
      case 2: {
        ...
        let warningMsg = calProperties.formatStringFromName(
