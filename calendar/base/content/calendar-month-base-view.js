...
// Wrap in a block to prevent leaking to window scope.
{
    ...
    class CalendarMonthBaseView extends MozElements.CalendarBaseView {
        ...
        setDateRange(startDate, endDate) {
            ...
            const viewStart = cal.getWeekInfoService()
                .getStartOfWeek(startDate.getInTimezone(this.mTimezone));

            const viewEnd = cal.getWeekInfoService()
                .getEndOfWeek(endDate.getInTimezone(this.mTimezone));
        ...
        relayout() {
            ...
            for (let i = 0; i < rows.length; i++) {
                ...
                for (let j = 0; j < row.childNodes.length; j++) {
                    ...
                    daybox.setAttribute("item-context",
