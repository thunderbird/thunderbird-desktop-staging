...
var TESTS = [
  {
    ...
    checkForAllowed: function img_checkAllowed(element) {
      return (
        element.QueryInterface(Ci.nsIImageLoadingContent).imageBlockingStatus ==
