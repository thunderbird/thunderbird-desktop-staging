...
document.getElementById("paneDisplay").addEventListener("paneload", function() {
  gDisplayPane.init();
});
...
var gDisplayPane = {
  ...
  _rebuildFonts() {
    ...
    var isSerif =
      gDisplayPane._readDefaultFontTypeForLanguage(langGroupPref.value) ==
      "serif";
...
Preferences.get("mailnews.mark_message_read.auto").on(
  "change",
  gDisplayPane.updateMarkAsReadOptions
);
